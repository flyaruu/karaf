...
set CLASSPATH=%KARAF_HOME%\system\org\apache\karaf\shell\org.apache.karaf.shell.console\3.0.0-SNAPSHOT\org.apache.karaf.shell.console-3.0.0-SNAPSHOT.jar
set CLASSPATH=%CLASSPATH%;%KARAF_HOME%\system\org\ops4j\pax\logging\pax-logging-api\1.7.0\pax-logging-api-1.7.0.jar
set CLASSPATH=%CLASSPATH%;%KARAF_HOME%\system\jline\jline\2.9\jline-2.9.jar
